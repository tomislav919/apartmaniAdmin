...
<head>
  ...
  <title>Apartmani Babe | Log in</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="/apartmaniAdmin/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="/apartmaniAdmin/controllers/loginCheck.php" method="post">
